...
public class SnmpTreeTest
{
    ...
    @Test
    public void testSnmpTreeMerge() throws SecurityException, NoSuchFieldException, NoSuchMethodException
    {
	...
	for(int i=0; i<=mergedTree.lastIndex; i++)
	    System.out.println(mergedTree.get(i));
