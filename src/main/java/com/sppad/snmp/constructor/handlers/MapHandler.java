...
public class MapHandler implements ObjectHandler
{
     ...
     * Foo<Object, Integer>, we can tell that the Map is Map<String, Integer>.
     * But if we have Bar <A, B> extends Foo<A, B> and FooBar extends
     * Bar<String, Integer>, there is no way to find this information through
     * generics, even though the JVM may have this information, depending on the
     * implementation.
     * 
     * @param field
     * @param collection
