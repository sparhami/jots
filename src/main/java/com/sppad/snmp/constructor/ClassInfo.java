...
public class ClassInfo
{
     ...
     * the specified base class are included. Object.class can be specified if
     * all fields are desired.
     * 
     * @param baseClass
     ...
     * does not search interfaces, so if a interface is the only common
     * ancestor, Object.class will be returned.
     * 
     * @param classList
     * @return The least common superclass.
     */
	...
	for (Object obj : objectList)
		...
		parentClass = getLeastCommonSuperclass(obj.getClass(),
			parentClass);
